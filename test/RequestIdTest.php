...
use Feedo\Stack\RequestIdGenerator;
...
class RequestIdTest extends TestCase
{
    ...
    {
        $this->requestIdGenerator = $this->getMock(RequestIdGenerator::class);
     ...
     * @test
     */
    public function it_does_set_a_new_request_id_if_it_was_already_present()
    {
        $this->requestIdGenerator->expects($this->once())
            ->method('generate')
            ->will($this->returnValue('yolo'));
